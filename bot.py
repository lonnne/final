...
def handle_help(message):
    bot.send_message(message.chat.id,"""Приветствую вас я телеграмм бот для озвучивания текста я оладаю лимитами 200 символов на сообшение и 1000 на пользователя чтобы начать озвучку /tts""")
